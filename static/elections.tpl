...
func conditions {
	    ...
	    x=DBIntWhere( Table("ge_campaigns"), "id", "type_id=$ and status!=1", $PositionId)
...
TextHidden( sc_GECandidateRegistration, sc_GENewElectionCampaign, sc_GEVoting, sc_GEVotingResalt, sc_LSSignature, sc_SLEdit, sc_SLNewVoting, sc_SLStartVoting, sc_SLVoting, sc_SLVotingResalt)
...
Json(`Head: "",
Desc: "General elections and vote in the Legislature",
		...
		Data: {
			...
			columns: '[["position_id", "int64", "1"],["status", "int64", "1"],["date_start", "time", "1"],["num_votes", "int64", "0"],["date_stop_voting", "time", "1"],["date_start_voting", "time", "1"],["candidates_deadline", "time", "1"],["name", "text", "0"],["type_id", "int64", "1"]]',
	   ...
	   },
{
		...
		Data: {
			...
			columns: '[["candidate", "text", "0"],["description", "text", "0"],["position_id", "int64", "1"],["application_date", "time", "0"],["counter", "int64", "1"],["campaign", "text", "0"],["citizen_id", "int64", "1"],["id_election_campaign", "int64", "1"],["result", "int64", "1"]]',
			permissions: "$citizen == #wallet_id#"
			}
	   },
{
	   ...
	   },
{
		...
		Data: {
			...
			columns: '[["citizen_id", "int64", "1"],["date_start", "time", "1"],["position_id", "int64", "1"],["name", "text", "0"],["date_end", "time", "1"],["position", "text", "0"]]',
			permissions: "$citizen == #wallet_id#"
			}
	   },
{
	   ...
	   },
{
		...
		Data: {
			...
			columns: '[["value", "text", "0"],["status", "int64", "1"],["laws_id", "int64", "1"],["date_end", "time", "1"],["resalt_for", "int64", "1"],["resalt_voting", "int64", "1"],["name", "text", "0"],["conditions", "text", "0"],["date_start", "time", "1"],["result_against", "int64", "1"],["date_voting_stop", "time", "1"],["date_voting_start", "time", "1"],["law_id", "int64", "1"]]',
			permissions: "$citizen == #wallet_id#"
			}
	   },
{
